...
# -*- coding: utf-8 -*-
#
# Airtable Python Wrapper documentation build configuration file, created by
...
htmlhelp_basename = "AirtablePythonWrapperdoc"
